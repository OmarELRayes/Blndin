 ...
 */
public class InviteSquadFragment extends Fragment implements InviteSquadView {
    @BindView(R.id.invitation_squad_recyclerView)RecyclerView recyclerView;
    RecyclerView.Adapter adapter;
    LinearLayoutManager layoutManager;
    InviteSquadPresenterImp presenter;
